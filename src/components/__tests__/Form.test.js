...
import { render, cleanup, getByPlaceholderText, getByTestId, queryByText, fireEvent } from "@testing-library/react";
...
describe("Form", () => {
  ...
  it("renders without without student name if not propvided", () => {
